...
export const learningToolsContent = {
  ...
  th: {
    ...
    workflow: {
      ...
      details: [
        { id: "scope", prepare: ["การตัดสินใจ กลุ่มผู้อ่าน หรือช่องว่างความรู้ที่งานต้องช่วยตอบ", "ขอบเขตด้านเวลาและหลักฐานที่ทำได้จริง"], actions: ["เลือกกรอบช่วยตั้งคำถาม", "กำหนดเกณฑ์คัดเข้าและคัดออก", "ระบุวิธีทบทวนพร้อมเหตุผล", "ทดลองขอบเขตกับบทความหลักบางส่วน"], example: "หากทำ scoping review เรื่องการรู้เท่าทัน AI ในมหาวิทยาลัย ควรกำหนดกลุ่มนักศึกษา แนวคิด บริบท ประเภทหลักฐาน ภาษา และช่วงเวลาให้ชัดก่อนค้น", pitfalls: ["เลือกวิธีก่อนตั้งคำถาม", "เปลี่ยนเกณฑ์หลังเห็นผลที่น่าสนใจโดยไม่บันทึกเหตุผล"], tools: ["เครื่องมือสร้าง PICO/PEO/SPIDER/SPICE/PCC", "แบบร่างโครงร่าง", "อาจารย์ที่ปรึกษาหรือบรรณารักษ์วิจัย"] },
    ...
    questionBuilder: {
      ...
      copied: "คัดลอกแล้ว",
      purposes: [
        { id: "effect", label: "ผลหรือการเปรียบเทียบ", description: "การแทรกแซง ปัจจัย ความสัมพันธ์ หรือผลลัพธ์" },
        { id: "experience", label: "ประสบการณ์หรือปัจจัยที่สนใจ", description: "ความหมาย ประสบการณ์ การยอมรับ หรือผลที่รับรู้" },
      ...
      frameworks: [
        { id: "pico", name: "PICO", description: "คำถามเฉพาะเรื่องผลหรือการเปรียบเทียบ", fields: [["population", "ประชากร"], ["intervention", "การแทรกแซง/ปัจจัย"], ["comparison", "ตัวเปรียบเทียบ"], ["outcome", "ผลลัพธ์"]] },
        { id: "peo", name: "PEO", description: "คำถามเรื่องประสบการณ์หรือปัจจัยที่สนใจ", fields: [["population", "ประชากร"], ["exposure", "ปัจจัย/ประสบการณ์"], ["outcome", "ผลลัพธ์หรือประสบการณ์"]] },
        { id: "spider", name: "SPIDER", description: "คำถามหลักฐานเชิงคุณภาพหรือแบบผสม", fields: [["sample", "กลุ่มตัวอย่าง"], ["phenomenon", "ปรากฏการณ์ที่สนใจ"], ["design", "รูปแบบการวิจัย"], ["evaluation", "สิ่งที่ประเมิน"], ["researchType", "ประเภทงานวิจัย"]] },
    ...
    screening: {
      ...
      scenarios: [
        { id: "empirical", title: "ระบบ AI ช่วยสอนในวิชาสถิติชั้นปีที่ 1", abstract: "งานควบคุมปี 2023 ในนักศึกษามหาวิทยาลัย 180 คน รายงานผลสัมฤทธิ์และการมีส่วนร่วม", expected: "include", rationale: "ประชากร การแทรกแซง ปี รูปแบบการวิจัย และผลลัพธ์ตรงกับเกณฑ์" },
