...
export type ScreeningDecision = "include" | "exclude" | "full-text" | "verify";
  ...
  en: {
    ...
    screening: {
      ...
      options: [
        ...
        { id: "full-text", label: "Check full text" }, { id: "verify", label: "Verify details" },
      ],
      scenarios: [
        ...
        { id: "borderline", title: "AI feedback assistant in postgraduate writing", abstract: "A mixed-methods university study reports engagement but it is unclear whether the system provides tutoring or only administrative feedback.", expected: "verify", rationale: "The abstract does not describe the intervention clearly enough. Check the full text and supplementary material first; if the study still does not report the needed detail, contact the corresponding author and record the evidence used for the decision." },
      ],
    },
    prisma: {
  ...
  th: {
    ...
    workflow: {
      ...
      details: [
        ...
        { id: "screen", prepare: ["รายการอ้างอิงหลังลบรายการซ้ำ", "เกณฑ์ที่สังเกตและตัดสินได้ พร้อมคำอธิบายที่ผู้วิจัยนำกลับมาใช้ซ้ำได้"], actions: ["ทดลอง 20–50 รายการและปรับคำอธิบายเกณฑ์ให้ชัด", "คัดกรองชื่อเรื่องและบทคัดย่อโดยไม่รีบตัดกรณีไม่ชัด", "ขอและประเมินฉบับเต็ม", "เมื่อข้อมูลยังไม่พอ ให้ตรวจเอกสารเสริมและติดต่อผู้เขียนที่รับผิดชอบการติดต่อหากจำเป็น พร้อมบันทึกเหตุผลหลักหนึ่งข้อเมื่อตัดบทความออก"], example: "หากบทคัดย่อไม่ระบุระดับการศึกษา ให้ส่งไปตรวจฉบับเต็มแทนการเดาว่าไม่ผ่านเกณฑ์", pitfalls: ["ใช้คุณภาพเป็นเกณฑ์เลือกใช้โดยไม่มีเหตุผลในโครงร่าง", "ตัดบทคัดย่อที่ข้อมูลไม่ชัดเร็วเกินไป"], tools: ["Rayyan, Covidence หรือ ASReview โดยให้มนุษย์ตัดสิน", "แบบบันทึกผลคัดกรอง", "จำนวนสำหรับผัง PRISMA"] },
        { id: "appraise", prepare: ["งานวิจัยที่เลือกใช้และจัดกลุ่มตามรูปแบบการวิจัย", "เครื่องมือที่ตรงกับรูปแบบและเป้าหมายของงานทบทวน"], actions: ["ฝึกผู้ประเมินด้วยตัวอย่าง", "ประเมินอย่างเป็นอิสระต่อกันตามที่ระเบียบวิธีกำหนด", "หารือหรือใช้ผู้ประเมินคนที่สามเมื่อผลไม่ตรงกัน", "สรุปผลและตรวจว่าคุณภาพมีผลต่อข้อค้นพบหรือไม่"], example: "ใช้ RoB 2 กับงานสุ่มทดลองและใช้เครื่องมือเชิงคุณภาพกับงานสัมภาษณ์ ไม่ควรบังคับงานทั้งสองชนิดลงรายการตรวจสอบชุดเดียว", pitfalls: ["สับสนระหว่างรายงานไม่ครบกับมีความเสี่ยงอคติสูง", "รวมคะแนนตามสูตรโดยไม่อธิบายเหตุผลประกอบ"], tools: ["RoB 2, ROBINS-I, CASP, JBI, MMAT หรือ AMSTAR 2 ตามความเหมาะสม", "แบบบันทึกการประเมิน", "แผนตรวจความไวของผล"] },
        ...
        { id: "write", prepare: ["ข้อค้นพบที่ระบุแหล่งหลักฐานและระดับความไม่แน่นอนได้ชัดเจน", "แนวทางรายงานที่ตรงกับวิธีทบทวน"], actions: ["รายงานวิธีให้ทีมอื่นทำตามได้", "แสดงลักษณะงานและขั้นตอนการคัดเลือก", "เชื่อมข้อสรุปกับผลประเมินและความเชื่อมั่น", "อภิปรายข้อจำกัด การนำไปใช้ และความจำเป็นในการปรับปรุงข้อมูล"], example: "แนบคำค้นเต็มของทุกฐานข้อมูลและตารางเหตุผลที่ตัดออกไว้ในเอกสารเสริม แทนการเขียนเพียงว่าค้นอย่างเป็นระบบ", pitfalls: ["สรุปผลเกินกว่าที่หลักฐานที่เลือกใช้มารองรับ", "ซ่อนการเปลี่ยนโครงร่างหรือการใช้ระบบอัตโนมัติ"], tools: ["PRISMA, PRISMA-ScR, ENTREQ, RAMESES หรือแนวทางเฉพาะวิธี", "โปรแกรมจัดการอ้างอิง", "รายการตรวจสอบการรายงาน"] },
      ],
    },
    ...
    checklist: {
      ...
      items: [
        ...
        { id: "criteria", stage: "วางแผน", label: "กำหนดและทดลองเกณฑ์เลือกใช้/ตัดออก" },
    ...
    screening: {
      ...
      criteria: "เลือกใช้งานวิจัยเชิงประจักษ์ตั้งแต่ปี 2020 ที่ศึกษา AI ช่วยสอนนักศึกษามหาวิทยาลัยและรายงานผลด้านการเรียนรู้หรือการมีส่วนร่วม ตัดบทบรรณาธิการ งานที่ศึกษาเฉพาะนักเรียน และงานเกี่ยวกับเครื่องมือที่ไม่ได้รายงานผลลัพธ์ของผู้เรียนออก",
      score: "คำตอบที่สอดคล้องกับเกณฑ์",
      correct: "ตอบได้ตรงกับเกณฑ์",
      review: "ควรทบทวนคำตอบนี้อีกครั้ง",
      reset: "ลองใหม่",
      options: [
        { id: "include", label: "เลือกใช้" }, { id: "exclude", label: "ตัดออก" },
        { id: "full-text", label: "ตรวจฉบับเต็ม" }, { id: "verify", label: "ตรวจข้อมูลเพิ่ม" },
      ],
      scenarios: [
        ...
        { id: "editorial", title: "เหตุใดมหาวิทยาลัยควรใช้ระบบ AI ช่วยสอน", abstract: "บทบรรณาธิการปี 2024 เสนอเหตุผลสนับสนุน แต่ไม่มีการศึกษาเชิงประจักษ์หรือผลลัพธ์ผู้เรียน", expected: "exclude", rationale: "เกณฑ์กำหนดให้ตัดบทบรรณาธิการออกและต้องมีผลการศึกษาเชิงประจักษ์" },
        ...
        { id: "school", title: "การสอนคณิตศาสตร์ ม.2 ด้วย Generative AI", abstract: "งานปี 2022 ในนักเรียนอายุ 13–14 ปี รายงานผลคะแนนสอบ", expected: "exclude", rationale: "เกณฑ์กำหนดให้เลือกใช้เฉพาะงานที่ศึกษานักศึกษามหาวิทยาลัย" },
        { id: "protocol", title: "โครงร่างการประเมินระบบ AI ช่วยสอนในมหาวิทยาลัย", abstract: "โครงร่างปี 2025 อธิบายผลลัพธ์ที่จะศึกษาแต่ยังไม่มีผลการวิจัย", expected: "exclude", rationale: "เกณฑ์ตัวอย่างกำหนดให้งานที่เลือกใช้ต้องมีผลการศึกษาเชิงประจักษ์แล้ว" },
        { id: "borderline", title: "ผู้ช่วย AI ให้คำแนะนำด้านการเขียนแก่นักศึกษาบัณฑิตศึกษา", abstract: "งานแบบผสมรายงานการมีส่วนร่วม แต่ไม่ชัดว่าเป็นการสอนหรือเพียงช่วยงานธุรการ", expected: "verify", rationale: "บทคัดย่ออธิบายขอบเขตการแทรกแซงไม่ชัด ควรอ่านฉบับเต็มและเอกสารเสริมก่อน หากยังไม่มีข้อมูลเพียงพอ ให้ติดต่อผู้เขียนที่รับผิดชอบการติดต่อ (corresponding author) และบันทึกข้อมูลที่ใช้ประกอบการตัดสินใจ" },
      ],
    },
    prisma: {
      ...
      inputs: [
        ...
        ["duplicatesRemoved", "รายการซ้ำที่ลบออก"], ["automationRemoved", "รายการที่ระบบตัดออกอัตโนมัติ"],
        ["otherRemoved", "รายการที่ตัดออกด้วยเหตุผลอื่น"], ["recordsExcluded", "รายการที่ตัดออกจากชื่อเรื่อง/บทคัดย่อ"],
        ["reportsNotRetrieved", "รายงานที่ไม่สามารถเข้าถึงฉบับเต็ม"], ["fullTextExcluded", "รายงานฉบับเต็มที่ตัดออก"],
      ],
      stages: { identified: "รายการที่ค้นพบ", removed: "รายการที่ตัดออกก่อนคัดกรอง", screened: "รายการที่คัดกรอง", sought: "รายงานที่ขอฉบับเต็ม", assessed: "รายงานฉบับเต็มที่ประเมิน", included: "งานวิจัยที่เลือกใช้" },
      example: {
        title: "ตัวอย่าง: การทบทวนเรื่อง AI ช่วยสอนในมหาวิทยาลัย",
        intro: "ตัวอย่างสมมตินี้แสดงว่าตัวเลขเปลี่ยนจากผลการค้นไปเป็นงานวิจัยที่เลือกใช้อย่างไร สังเกตว่าผลรวมของเหตุผลที่ตัดออกในขั้นฉบับเต็มต้องเท่ากับจำนวนรายงานฉบับเต็มที่ตัดออก",
