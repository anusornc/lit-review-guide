  ...
  th: {
    ...
    questionBuilder: {
      ...
      frameworks: [
        ...
        { id: "pcc", name: "PCC", description: "คำถามสำหรับการทบทวนวรรณกรรมแบบกำหนดขอบเขตและการทำแผนที่หลักฐาน", fields: [["population", "ประชากร/ผู้มีส่วนเกี่ยวข้อง"], ["concept", "แนวคิด"], ["context", "บริบท"]] },
      ],
    },
    screening: {
