...
export const learningToolsContent = {
  en: {
    ...
    questionBuilder: {
      ...
      frameworks: [
        { id: "pico", name: "PICO", description: "A focused question comparing effects or outcomes", fields: [["population", "Population or problem", "First-year university students"], ["intervention", "Method, programme, or option", "Flipped-classroom teaching"], ["comparison", "What it is compared with", "Lecture-based teaching"], ["outcome", "Outcome of interest", "Achievement and classroom engagement"]], exampleQuestion: "Among first-year university students, does flipped-classroom teaching improve achievement and classroom engagement compared with lecture-based teaching?" },
        { id: "peo", name: "PEO", description: "A question about what a group experiences or is exposed to", fields: [["population", "Population", "Secondary-school teachers using AI for the first time"], ["exposure", "Exposure or experience", "Using generative AI to plan lessons"], ["outcome", "Experience or perceived outcome", "Changes in their role and ethical concerns"]], exampleQuestion: "How do secondary-school teachers using generative AI to plan lessons experience changes in their role and ethical concerns?" },
        { id: "spider", name: "SPIDER", description: "An in-depth qualitative or mixed-method question", fields: [["sample", "Sample", "Small independent restaurant owners"], ["phenomenon", "Issue or experience to explore", "Using food-delivery platforms"], ["design", "Study design", "In-depth interviews"], ["evaluation", "What participants report", "Benefits, barriers, and adaptation"], ["researchType", "Research type", "Qualitative research"]], exampleQuestion: "What benefits, barriers, and forms of adaptation do small independent restaurant owners report when using food-delivery platforms in qualitative interview studies?" },
        { id: "spice", name: "SPICE", description: "A question comparing a service, policy, or practice option", fields: [["setting", "Setting", "University mental-health centres"], ["perspective", "Whose perspective", "Students who have used the service"], ["intervention", "Service, policy, or option", "Video counselling"], ["comparison", "Alternative", "In-person counselling"], ["evaluation", "How it will be judged", "Satisfaction and continued attendance"]], exampleQuestion: "From the perspective of students using university mental-health centres, how does video counselling compare with in-person counselling for satisfaction and continued attendance?" },
        { id: "pcc", name: "PCC", description: "A broad scoping or evidence-mapping question", fields: [["population", "Population or participants", "Local disaster-management agencies"], ["concept", "Concept to map", "Artificial intelligence for forecasting and early warning"], ["context", "Context", "Resource-constrained developing countries"]], exampleQuestion: "What research exists on the use of artificial intelligence for forecasting and early warning by local disaster-management agencies in resource-constrained developing countries?" },
      ],
    },
    screening: {
  ...
  th: {
    ...
    checklist: {
      ...
      progress: "ทำแล้ว",
      items: [
        { id: "question", stage: "เตรียม", label: "เขียนคำถามที่ทบทวนได้และระบุสิ่งที่งานต้องการช่วยเติมเต็ม" },
