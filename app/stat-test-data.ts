...
export const statChooserText = {
  ...
  th: {
    ...
    caution: "แผนผังนี้ครอบคลุมสถิติพื้นฐานที่ใช้บ่อย แต่ยังไม่ครอบคลุมข้อมูลแบบกลุ่มหรือแบบติดตามระยะยาว แบบจำลองผสม การวิเคราะห์การรอดชีพ ข้อมูลจำนวนนับ ข้อมูลสูญหาย การอนุมานเชิงสาเหตุ และการสุ่มตัวอย่างที่ซับซ้อน",
    start: "เริ่มต้น",
    step: "คำถามข้อที่",
...
export const statRecommendations: Record<StatResultId, StatRecommendation> = {
  ...
  2: {
    ...
    assumptions: { th: "แต่ละหน่วยสังเกตเป็นอิสระ ตัวแปรตามเป็นเชิงปริมาณ และการแจกแจงภายในกลุ่มไม่ผิดปกติรุนแรง", en: "Independent observations, a quantitative outcome, and no severe distributional problems within groups." },
  ...
  5: {
    ...
    caution: { th: "หาก interaction มีนัยสำคัญ ควรแปลผลผ่าน simple effects หรือ estimated marginal means แทนการดู main effects เพียงอย่างเดียว", en: "When an interaction is meaningful, interpret simple effects or estimated marginal means rather than main effects alone." },
  ...
  6: {
    ...
    caution: { th: "เป็น exact test จึงเหมาะกับตัวอย่างขนาดเล็กได้ แต่ยังต้องตรวจว่าหน่วยสังเกตเป็นอิสระจริง", en: "It is an exact test and can suit small samples, but independence of trials still matters." },
  ...
  7: {
    ...
    assumptions: { th: "ข้อมูลเชื่อมโยงกับหน่วยตัวอย่างถูกต้อง เศษเหลือเหมาะสม และสำหรับ repeated-measures ANOVA ต้องตรวจ sphericity หรือใช้วิธีปรับแก้", en: "Measurements are correctly linked by subject, residual assumptions are suitable, and sphericity is checked or corrected for repeated-measures ANOVA." },
    ...
    alternative: { name: "Friedman test", reason: { th: "ข้อมูลอย่างน้อยเป็นอันดับ วัดครบทุกช่วง และไม่เหมาะกับ repeated-measures ANOVA", en: "at least ordinal, complete repeated data unsuitable for repeated-measures ANOVA" } },
  ...
  8: {
    ...
    caution: { th: "หากค่าคาดหวังต่ำ ควรรวมหมวดหมู่อย่างมีเหตุผลหรือใช้ exact/Monte Carlo method ที่เหมาะสม", en: "For sparse expected counts, combine categories only with substantive justification or use a suitable exact or Monte Carlo method." },
  ...
  9: {
    ...
    caution: { th: "หากเป็นข้อมูลก่อน–หลังในคนเดิม ให้ใช้ McNemar ไม่ใช่ chi-square แบบอิสระ", en: "For paired before-and-after binary data, use McNemar rather than the independent chi-square test." },
  ...
  11: {
    ...
    assumptions: { th: "เลือกค่ากลางและการกระจายให้เหมาะกับข้อมูล; Pearson ต้องการความสัมพันธ์เชิงเส้นและควรตรวจ scatterplot ส่วน Spearman เหมาะกับข้อมูลอันดับหรือความสัมพันธ์แบบ monotonic", en: "Choose summaries that fit the distribution; Pearson targets linear association and should be paired with a scatterplot, while Spearman suits ordinal or monotonic relationships." },
    ...
    alternative: { name: "Spearman’s rho", reason: { th: "ข้อมูลเป็นอันดับหรือความสัมพันธ์เป็นแบบ monotonic แต่ไม่เป็นเส้นตรง", en: "ordinal data or a monotonic but non-linear relationship" } },
  ...
  13: {
    ...
    assumptions: { th: "รูปแบบความสัมพันธ์ถูกกำหนดเหมาะสม เศษเหลือเป็นอิสระ มีความแปรปรวนคงที่ และไม่มีปัญหา multicollinearity รุนแรง; ตรวจกราฟวินิจฉัยของแบบจำลอง", en: "Correct functional form, independent errors, constant error variance, and no severe multicollinearity; inspect model diagnostics." },
  ...
  14: {
    ...
    assumptions: { th: "ผลลัพธ์มีสองทาง หน่วยสังเกตเป็นอิสระ ตัวแปรต่อเนื่องสัมพันธ์เชิงเส้นกับ logit ไม่มี multicollinearity รุนแรง และมีจำนวนเหตุการณ์เพียงพอต่อความซับซ้อนของแบบจำลอง", en: "Binary outcome, independent observations, linearity of continuous predictors with the logit, no severe multicollinearity, and enough events for model complexity." },
    caution: { th: "กฎ 10 เหตุการณ์ต่อตัวแปรเป็นเพียงแนวทางคร่าว ๆ ควรพิจารณาขนาดตัวอย่าง ความชุก การแยกกลุ่มสมบูรณ์ การปรับแบบจำลอง และการตรวจสอบความเที่ยงตรงร่วมกัน", en: "Ten events per variable is only a rough guideline; consider sample size, prevalence, separation, regularization, and model validation together." },
