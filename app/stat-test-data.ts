...
export const statChooserText = {
  en: {
    index: "Supplement",
    title: "Statistical test chooser for research data",
    intro: "Use this supplement only after you have defined the research question, study design, and data types. It supports the choice of an analysis method; it is not a core step in conducting a literature review.",
    ...
    start: "Start",
    step: "Question",
    example: "Example research question",
  ...
  th: {
    index: "ภาคเสริม",
    title: "ตัวช่วยเลือกสถิติสำหรับวิเคราะห์ข้อมูลงานวิจัย",
    intro: "ใช้ส่วนนี้เมื่อกำหนดคำถาม ออกแบบการวิจัย และทราบชนิดข้อมูลแล้ว เครื่องมือนี้ช่วยเลือกวิธีวิเคราะห์ข้อมูลเบื้องต้น ไม่ใช่ขั้นตอนหลักของการทบทวนวรรณกรรม",
...
export const statRecommendations: Record<StatResultId, StatRecommendation> = {
  1: {
    ...
    exampleQuestion: { th: "คะแนนเฉลี่ยของนักศึกษาต่างจากเกณฑ์ 70 คะแนนหรือไม่", en: "Is the mean student score different from a 70-point benchmark?" },
  ...
  2: {
    ...
    exampleQuestion: { th: "คะแนนเฉลี่ยของกลุ่มเรียนออนไลน์กับกลุ่มเรียนในชั้นเรียนต่างกันหรือไม่", en: "Do mean scores differ between online and classroom groups?" },
  ...
  3: {
    ...
    exampleQuestion: { th: "คะแนนเฉลี่ยของนักศึกษาก่อนและหลังอบรมต่างกันหรือไม่", en: "Do students' mean scores differ before and after training?" },
  ...
  4: {
    ...
    exampleQuestion: { th: "คะแนนเฉลี่ยของนักศึกษาในสามรูปแบบการสอนต่างกันหรือไม่", en: "Do mean student scores differ across three teaching methods?" },
  ...
  5: {
    ...
    exampleQuestion: { th: "รูปแบบการสอนและระดับชั้นมีผลต่อคะแนน และมีปฏิสัมพันธ์กันหรือไม่", en: "Do teaching method and year level affect scores, and do they interact?" },
    assumptions: { th: "หน่วยสังเกตเป็นอิสระ ค่าส่วนเหลือมีการแจกแจงใกล้เคียงปกติ ความแปรปรวนเท่ากันระหว่างกลุ่ม และมีข้อมูลเพียงพอในแต่ละเซลล์ของการออกแบบ", en: "Independent observations, approximately normal residuals, suitable variance structure, and adequate data in each design cell." },
  ...
  6: {
    ...
    exampleQuestion: { th: "สัดส่วนนักศึกษาที่สอบผ่านต่างจากเกณฑ์ร้อยละ 70 หรือไม่", en: "Does the proportion of students who pass differ from 70%?" },
    ...
    commands: { SPSS: "Analyze → Nonparametric Tests → Legacy Dialogs → Binomial", R: "binom.test(45, 100, p = 0.5)", Python: "stats.binomtest(45, 100, p=0.5)", Jamovi: "Frequencies → 2 Outcomes (Binomial)", Stata: "bitest x == 0.5", Excel: "=BINOM.DIST(...) # คำนวณความน่าจะเป็น; ต้องคำนวณ p-value ให้สอดคล้องกับสมมติฐาน" },
    sourceIds: ["ucla-stat-choice", "r-stats", "scipy-stats"],
  },
  7: {
    id: 7,
    ...
    exampleQuestion: { th: "คะแนนของผู้เรียนที่วัดสามช่วงเวลาแตกต่างกันหรือไม่", en: "Do learner scores differ across three measurement occasions?" },
  ...
  8: {
    ...
    exampleQuestion: { th: "สัดส่วนผู้ตอบในแต่ละตัวเลือกต่างจากสัดส่วนที่คาดไว้หรือไม่", en: "Do response proportions across categories differ from the expected proportions?" },
  ...
  9: {
    ...
    exampleQuestion: { th: "รูปแบบการเรียนสัมพันธ์กับผลสอบผ่านหรือไม่ผ่านหรือไม่", en: "Is learning mode associated with pass or fail status?" },
  ...
  10: {
    ...
    exampleQuestion: { th: "สัดส่วนผู้ตอบถูกก่อนและหลังอบรมเปลี่ยนไปหรือไม่", en: "Did the proportion of correct responses change after training?" },
  ...
  11: {
    ...
    exampleQuestion: { th: "คะแนนมีการกระจายอย่างไร และเวลาอ่านหนังสือสัมพันธ์กับคะแนนหรือไม่", en: "How are scores distributed, and is study time associated with scores?" },
  ...
  12: {
    ...
    exampleQuestion: { th: "ผู้เข้าร่วมกระจายตามเพศและชั้นปีอย่างไร", en: "How are participants distributed by gender and year level?" },
  ...
  13: {
    ...
    exampleQuestion: { th: "เวลาอ่านหนังสือและการเข้าเรียนช่วยพยากรณ์คะแนนสอบได้เพียงใด", en: "How well do study time and attendance predict exam scores?" },
  ...
  14: {
    ...
    exampleQuestion: { th: "ปัจจัยใดสัมพันธ์กับโอกาสสอบผ่านของนักศึกษา", en: "Which factors are associated with a student's probability of passing?" },
