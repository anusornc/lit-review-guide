...
Report: verdict [supported | partly supported | unsupported | unable to verify], exact supporting location, mismatches, missing context, and a revised claim whose strength stays within the evidence.`,
  ...
  th: {
    ...
    methodDeepDives: {
      ...
      mixed: { search: "วางการค้นที่เชื่อมโยงกัน หรือใช้คำค้นชุดเดียวที่ครอบคลุมทั้งหลักฐานเชิงปริมาณและเชิงคุณภาพ", appraisal: "ประเมินงานวิจัยแต่ละรูปแบบให้เหมาะสม แล้วพิจารณาเหตุผลและคุณภาพของการผสานหลักฐาน", reporting: "ใช้แนวทางที่เหมาะกับหลักฐานแต่ละประเภท และอธิบายวิธีผสานผลให้ชัดเจน", tools: "ระบบงานทบทวน · โปรแกรมสถิติ · โปรแกรมเชิงคุณภาพ · joint display", reference: "equator" },
