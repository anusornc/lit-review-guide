...
Report: verdict [supported | partly supported | unsupported | unable to verify], exact supporting location, mismatches, missing context, and a revised claim whose strength stays within the evidence.`,
      ...
      toolDirectorySource: "Candidate tools were identified from the Effortless Academic tools list, checked against this directory, and linked to their official sites.",
      ...
      toolCategories: [
        ...
        {
          id: "discovery", title: "Literature discovery & paper reading", description: "Find candidate studies, expand from seed papers, inspect citation context, and question documents without treating AI summaries as evidence.",
          tools: [
  ...
  th: {
    ...
    extraMethods: [
      ...
      {
        id: "systematic-search", name: "การค้นและทบทวนวรรณกรรมอย่างเป็นระบบ", family: "การค้นเพื่อวิทยานิพนธ์",
      ...
      {
        id: "meta-ethnography", name: "การสังเคราะห์แบบเมตาชาติพันธุ์วรรณนา", family: "การสังเคราะห์เชิงตีความ",
    ...
    disciplineDeepDives: {
      ...
      education: { journals: ["Review of Educational Research", "Educational Research Review", "Teaching and Teacher Education"], standards: ["PRISMA เมื่อเหมาะสม", "RAMESES สำหรับการสังเคราะห์เชิงสัจนิยม", "แนวทางเฉพาะวิธีเชิงคุณภาพ"], tools: ["EPPI-Reviewer", "Rayyan", "NVivo", "Zotero"], tip: "บันทึกช่วงวัย บริบท ความครบถ้วนของการใช้กิจกรรม และความเป็นธรรม เพราะผลมักไม่ย้ายข้ามบริบทโดยอัตโนมัติ" },
    ...
    workflow: {
      ...
      phases: [
        ...
        { title: "ค้น", purpose: "แยกคำถามออกเป็นแนวคิด คำพ้อง และแหล่งข้อมูล พร้อมบันทึกวิธีค้นให้ผู้อื่นทำตามได้", outputs: ["ชุดแนวคิด", "คำค้นที่ทดลองแล้ว", "บันทึกการค้น"], checkpoint: "คำค้นพบงานสำคัญที่รู้จักอยู่แล้ว และผู้อื่นนำไปค้นตามได้หรือไม่" },
...
รายงานผลเป็น [รองรับ | รองรับบางส่วน | ไม่รองรับ | ยังตรวจไม่ได้] พร้อมตำแหน่งหลักฐาน จุดที่ไม่ตรง บริบทที่ขาด และข้อความฉบับแก้ที่มีน้ำหนักไม่เกินกว่าหลักฐาน`,
      ...
      toolDirectorySource: "คัดเลือกเครื่องมือเพิ่มเติมจากรายการของ Effortless Academic โดยตรวจไม่ให้ซ้ำกับรายการเดิม และเชื่อมไปยังเว็บไซต์ทางการของแต่ละเครื่องมือ",
      ...
      toolCategories: [
        ...
        {
          id: "discovery", title: "ค้นบทความและช่วยอ่านงานวิจัย", description: "ค้นงานที่อาจเกี่ยวข้อง ขยายผลจากบทความตั้งต้น ตรวจบริบทการอ้างอิง และถามข้อมูลจากเอกสาร โดยไม่ใช้บทสรุปจาก AI แทนหลักฐานต้นฉบับ",
          tools: [
        ...
        },
        {
          ...
          tools: [
            ...
            { name: "Yomu AI", access: "มีทั้งแผนฟรีและเสียเงิน", bestFor: "พื้นที่เขียนงานวิชาการที่รวมการร่าง ปรับแก้ จัดการการอ้างอิง และจัดรูปแบบไว้ด้วยกัน", watchFor: "ตรวจการคัดลอกซ้ำและแหล่งข้อมูลแยกต่างหาก รวมถึงตรวจเอกสารอ้างอิงและข้อเท็จจริงทุกจุดที่ระบบสร้าง", links: [{ label: "Yomu AI", href: "https://www.yomu.ai/" }] },
          ],
        },
        {
